...
import com.mucheng.editor.base.panel.AbstractAutoCompletionPanel.Companion.KEYWORD
import com.mucheng.editor.base.panel.AbstractAutoCompletionPanel.Companion.SPECIAL
...
open class DefaultAutoCompletionHelper : IAutoCompletionHelper {
    ...
    override fun getIconDrawable(editor: MuCodeEditor, type: String): Drawable? {
        ...
        return when (type) {
            KEYWORD -> ContextCompat.getDrawable(
                context,
                R.drawable.ic_auto_completion_keyword
            )
            VARIABLE -> ContextCompat.getDrawable(
                context,
                R.drawable.ic_auto_completion_variable
            )
            FUNCTION -> ContextCompat.getDrawable(
                context,
                R.drawable.ic_auto_completion_function
            )
            SPECIAL -> ContextCompat.getDrawable(
                context,
    ...
    override fun skipCharIfNeeded(editor: MuCodeEditor, char: Char): Boolean {
        val language = editor.getCurrentCodeBlockLanguage() ?: editor.getLanguage()
    ...
    override fun getKeywordType(): String {
        return KEYWORD
    }
    ...
    override fun getFunctionType(): String {
        return FUNCTION
    }

    override fun getSpecialType(): String {
        return SPECIAL
    }
