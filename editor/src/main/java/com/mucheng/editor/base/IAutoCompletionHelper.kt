...
interface IAutoCompletionHelper {

    fun getIconDrawable(editor: MuCodeEditor, type: String): Drawable?

    fun skipCharIfNeeded(editor: MuCodeEditor, char: Char): Boolean

    fun isMatchedInsertedText(): Boolean
