...
package com.mucheng.web.devops.openapi.editor.lang.xml;
...
public class XMLParser extends Parser {
	...
	public static final int
		COMMENT=1, COMMENT_OPEN=2, CDATA=3, DTD=4, EntityRef=5, CharRef=6, SEA_WS=7, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "COMMENT", "COMMENT_OPEN", "CDATA", "DTD", "EntityRef", "CharRef", 
